...
[time,tension,theta] = getExpData("GuyWireSysID-2022-08-10",-1,60); % t0 just after the step
hold on; plot(time,tension,'.g')
hold on; plot(time,theta,'k')
legend("Model Tension","Experiment Tension","Stepper Angle")
ylim([3 6])
